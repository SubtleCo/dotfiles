...
-- TODO: Figure out how to congiure node to use launch.json
-- vscode.load_launchjs(nil, { node = { 'typescript', 'javascript' }})
...
vim.diagnostic.config("DapBreakpoint", { text = "", texthl = "DiagnosticSignError", linehl = "", numhl = "" })
